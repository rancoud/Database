...
1. [Fork](https://github.com/rancoud/database/fork) and clone the repository
...
7. Push to your fork and [submit a pull request](https://github.com/rancoud/database/compare)
